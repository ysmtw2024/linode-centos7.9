...
"
get_node_url(){
	nodes=(http://128.1.164.196 http://download.bt.cn);
	i=1;
	if [ ! -f /bin/curl ];then
...
Install_setuptools()
{
	if [ ! -f "/usr/bin/easy_install" ];then
		wget -O setuptools-33.1.1.zip https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/setuptools-33.1.1.zip -T 10
...
Install_pip()
{
	...
	if [ "$ispip" == "" ];then
		...
		wget -O pip-9.0.1.tar.gz https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/pip-9.0.1.tar.gz -T 10
...
Install_Pillow()
{
	...
	if [ "$isSetup" = "" ];then
		...
		wget -O Pillow-3.2.0.zip https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/Pillow-3.2.0.zip -T 10
...
Install_psutil()
{
	...
	if [ "$isSetup" = "" ];then
		wget -O psutil-5.2.2.tar.gz https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/psutil-5.2.2.tar.gz -T 10
...
Install_mysqldb()
{
	...
	if [ "$isSetup" = "" ];then
		wget -O MySQL-python-1.2.5.zip https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/MySQL-python-1.2.5.zip -T 10
...
Install_chardet()
{
	...
	if [ "$isSetup" = "" ];then
		wget -O chardet-2.3.0.tar.gz https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/chardet-2.3.0.tar.gz -T 10
...
Install_webpy()
{
	...
	if [ "$isSetup" = "" ];then
		wget -O web.py-0.38.tar.gz https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/web.py-0.38.tar.gz -T 10
...
wget -O $setup_path/server/panel/certbot-auto https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/certbot-auto.init -T 5
...
wget -O panel.zip https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/panel.zip -T 10
wget -O /etc/init.d/bt https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/bt.init -T 10
...
wget -O acme_install.sh https://raw.githubusercontent.com/ysmtw2024/linode-centos7.9/master/acme_install.sh
